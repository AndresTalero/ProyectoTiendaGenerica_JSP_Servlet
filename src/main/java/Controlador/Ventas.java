...
public class Ventas extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("consultar_cli") != null) {
			...
			ClienteDTO cli = DETADAO.Buscar_Cliente(cedula);
			if (cli != null) {
				String nombre;
				cedula = cli.getCedulaCliente();
		...
		if (request.getParameter("confirmar") != null) {				
			...
			String usuario = Login.usua;
			UsuarioDTO cedulaUsua = usuDAO.buscar_cedula(usuario);
			long cedulaUsuario = cedulaUsua.getCedulaUsuario();
